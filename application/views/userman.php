                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url('index.php/uman?delete='); echo $this->safe->convert($post->username,$this->session->userdata("uname")); ?>" data-toggle="tooltip" title="Hapus akun '<?php echo $post->username; ?>'" onclick="return confirm('Hapus akun <?php echo $post->nama_user; ?>?')"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus Akun</button></a>
                                </td>
                            </tr>
